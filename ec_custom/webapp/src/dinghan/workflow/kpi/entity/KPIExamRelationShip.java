...
public class KPIExamRelationShip {
	 ...
	 * 跨部门考核项目集合
	 */
	private List<CrossKPIProjectInfo> crossKPIProjectInfoList;
	
	public List<CrossKPIProjectInfo> getCrossKPIProjectInfoList() {
		return crossKPIProjectInfoList;
	}

	public void setCrossKPIProjectInfoList(List<CrossKPIProjectInfo> crossKPIProjectInfoList) {
		this.crossKPIProjectInfoList = crossKPIProjectInfoList;
	}
