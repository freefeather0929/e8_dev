...
public class KQMailService {
	...
	public void executeMail(){
		...
		//mail.setHost("smtp."+fromaddr.substring(fromaddr.indexOf("@")+1));
		//mail.setHost("163.177.103.36");
		mail.setHost("10.10.66.222");
		mail.setContent(tip+"<br/><br/>"+this.mailInfoMap.get("content"));	//内容
		mail.setContentType("html");
		mail.setFrom(this.formAdress);	//发送地址
		mail.setFromName(this.formName);	//发送人姓名
		mail.setFromPwd(this.fromPwd);	//密码
		
		mail.setValidate(false);	//登录认证
		mail.setRecipients(this.mailInfoMap.get("mailto").split(","));		//接收人地址
		mail.setRecipientsName(this.mailInfoMap.get("mailtoName").split(",") );		//接收人姓名
		mail.setSubject(this.mailInfoMap.get("subject"));
		//mail.setFilePath("E:\\其它\\车间管理模块需求分析.docx"); //必须是服务器上的路径
	...
	private void createKQCollectMailInfo(String userCode,String month){
		...
		String Sql = "select h.Code,h.NameCN,h.Mail,h.Company,h.KaoQinType,h.DeptOneNameText,h.DeptTwoNameText,h.DeptThreeNameText,h.InCompany,h.Post,"
				+ "k.hzyf,k.ycqts,k.jbgs,k.jbztx,k.sj,k.bj,k.hj,k.sangj,k.cj,k.cjj,k.lcj,k.jyj,k.jsj,k.grgs,k.kg,k.trgs,k.wdk,k.brj,k.nxj,k.txj,k.synx,k.sytx"
				+ " from uf_kqhz k,uf_hr_userinfo1 h where h.Code = k.gh and h.Code = '" +_userCode+ "' and k.hzyf = '"+ _month +"'";
		...
		while(hrrs.next()){
			...
			System.out.println("mail address :: "+mailto);
			mailtoName = hrrs.getString("NameCN");
			
			mailContent += "<tr>";	//标题
			mailContent += "<td colspan=\"4\" style=\"background-color: #1e90ff\">"
									+"<span style=\"display: block; border-width: 0;font-size:14px;font-weight:bold;text-align: center\">月考勤汇总统计表</span>"
								+"</td>";
			mailContent += "</tr>";
			...
			mailContent += "<td style=\"width:30%;\">"+hrrs.getString("")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">任职状态：</td>";
			
			if(hrrs.getString("InCompany") == "0"){
			...
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("jbgs")+"</td>";
			mailContent += "<td style=\"width:20%;\">加班转调休：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("jbztx")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">事假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("sj")+"</td>";
			mailContent += "<td style=\"width:20%;\">病假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("bj")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">婚假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("hj")+"</td>";
			mailContent += "<td style=\"width:20%;\">丧假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("sangj")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">产假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("cj")+"</td>";
			mailContent += "<td style=\"width:20%;\">产检假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("cjj")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">流产假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("lcj")+"</td>";
			mailContent += "<td style=\"width:20%;\">节育假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("jyj")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">计划生育假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("jsj")+"</td>";
			mailContent += "<td style=\"width:20%;\">个人工伤假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("grgs")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">旷工工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("kg")+"</td>";
			mailContent += "<td style=\"width:20%;\">他人工伤假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("trgs")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">忘打卡次数：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("wdk")+"</td>";
			mailContent += "<td style=\"width:20%;\">迟到次数：</td>";
			mailContent += "<td style=\"width:30%;\">"+ hrrs.getString("cd")+"</td>";
			mailContent += "</tr>";
			...
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("brj")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">年休假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("nxj")+"</td>";
			mailContent += "<td style=\"width:20%;\">调休假工时：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("txj")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td style=\"width:20%;\">剩余年休假：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("synx")+"</td>";
			mailContent += "<td style=\"width:20%;\">剩余调休假：</td>";
			mailContent += "<td style=\"width:30%;\">"+hrrs.getDouble("sytx")+"</td>";
			mailContent += "</tr>";
			
			mailContent += "<tr>";
			mailContent += "<td colspan=\"4\" style=\"text-align:center\">";
			mailContent += "<a target=\"_blank\" style=\"color:#ff0000\" href=\"http://oa.dinghantech.com/formmode/search/CustomSearchBySimple.jsp?customid=79\">";
