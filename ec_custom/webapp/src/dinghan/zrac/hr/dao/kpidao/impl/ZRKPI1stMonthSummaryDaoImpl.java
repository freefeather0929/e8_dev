...
import dinghan.zrac.hr.dao.kpidao.ZRKPI1stMonthSummaryDao;
import dinghan.zrac.hr.entity.kpientity.ZRKPI1stMonthSummary;
 ...
 * 
 */
public class ZRKPI1stMonthSummaryDaoImpl implements ZRKPI1stMonthSummaryDao{
	...
	public ZRKPIMonthSummary queryById(int id) {
		...
		while(rs.next()){
			kpiMonthSummary = new ZRKPI1stMonthSummary();
			kpiMonthSummary.setId(rs.getInt("id"));
			kpiMonthSummary.setMainid(rs.getInt("mainid"));
			kpiMonthSummary.setKpitarget(rs.getString("d_m1_kpitarget"));
			kpiMonthSummary.setKpistandard(rs.getString("d_m1_kpistandard"));
			kpiMonthSummary.setKpiweight(rs.getInt("d_m1_kpiweight"));
			kpiMonthSummary.setSummary(rs.getString("d_m1_summary"));
			kpiMonthSummary.setSumpsn(rs.getInt("d_m1_sumpsn"));
			kpiMonthSummary.setSumdate(rs.getString("d_m1_sumdate"));
			kpiMonthSummary.setKpidtid(rs.getInt("d_m1_kpidtid"));
		}
	...
	public boolean update(ZRKPIMonthSummary kpiMonthSummary) {
		...
		sql.append(kpiMonthSummary.getMainid());
		sql.append("',");
		sql.append("d_m1_kpitarget = '");
		sql.append(kpiMonthSummary.getKpitarget());
		sql.append("',");
		sql.append("d_m1_kpistandard = '");
		sql.append(kpiMonthSummary.getKpistandard());
		sql.append("',");
		sql.append("d_m1_kpiweight = '");
		sql.append(kpiMonthSummary.getKpiweight());
		sql.append("',");
		sql.append("d_m1_summary = '");
		sql.append(kpiMonthSummary.getSummary());
		sql.append("',");
		sql.append("d_m1_sumpsn = '");
		sql.append(kpiMonthSummary.getSumpsn());
		sql.append("',");
		sql.append("d_m1_sumdate = '");
		sql.append(kpiMonthSummary.getSumdate());
		sql.append("',");
		sql.append("d_m1_kpidtid = '");
		sql.append(kpiMonthSummary.getKpidtid());
		sql.append("'");
		sql.append(" where id = ");
