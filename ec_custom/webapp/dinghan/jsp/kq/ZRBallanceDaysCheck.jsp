...
<%@page import="dinghan.workflow.kq.userinfo.offdays.BallanceDaysHaddle"%>
...
<%
	...
	BallanceDaysHaddle haddle = new BallanceDaysHaddle();
	...
	double added = haddle.queryAddHourbyOverTime(userID, curDate);
